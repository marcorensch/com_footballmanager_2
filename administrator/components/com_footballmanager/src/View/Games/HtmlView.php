...
namespace NXD\Component\Footballmanager\Administrator\View\Games;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        try {
            /* @var \NXD\Component\Footballmanager\Administrator\Model\GamesModel $model */
            $model = $this->getModel();
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_FOOTBALLMANAGER_GAMES'), 'fas fa-football-ball');

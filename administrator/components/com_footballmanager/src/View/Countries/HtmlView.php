...
class HtmlView extends BaseHtmlView
{
	...
	{
        try {
            /* @var \NXD\Component\Footballmanager\Administrator\Model\CountriesModel $model */
            $model = $this->getModel();
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_('COM_FOOTBALLMANAGER_COUNTRIES'), 'fas fa-globe');
...
//			ToolbarHelper::custom('countries.export', 'download', '', 'COM_FOOTBALLMANAGER_EXPORT', true);
		}

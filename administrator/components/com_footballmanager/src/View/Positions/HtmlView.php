...
namespace NXD\Component\Footballmanager\Administrator\View\Positions;
...
class HtmlView extends BaseHtmlView
{
    ...
    {
        try {
            /* @var \NXD\Component\Footballmanager\Administrator\Model\PositionsModel $model */
            $model = $this->getModel();
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_FOOTBALLMANAGER_POSITIONS'), 'fas fa-hat-cowboy');
...
//			ToolbarHelper::custom('positions.export', 'download', '', 'COM_FOOTBALLMANAGER_EXPORT', true);
        }

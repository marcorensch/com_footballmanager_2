...
class CountryModel extends AdminModel
{
	 ...
	 * @since  __BUMP_VERSION__
	 */
	public $typeAlias = 'com_footballmanager.country';

	protected $associationsContext = 'com_footballmanager.country';
	private $itemId = 0;
	...
	{
		// Get the form.
		$form = $this->loadForm($this->typeAlias, 'country', ['control' => 'jform', 'load_data' => $loadData]);
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_footballmanager.edit.country.data', []);
		...
		$this->preprocessData('com_footballmanager.country', $data);
	...
	public function getItem($pk = null)
	{
		...
		if (Associations::isEnabled())
		{
			...
			if ($item->id !== null)
			{
				$associations = Associations::getAssociations('com_footballmanager', '#__footballmanager_countries', 'com_footballmanager.country', $item->id, 'id', null);

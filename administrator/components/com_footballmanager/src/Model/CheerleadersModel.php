 ...
 */
class CheerleadersModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__footballmanager_cheerleaders', 'a'));
	...
	public function exportItems($ids)
	{
		...
		$query = $db->getQuery(true);
		$query->select('*');
		$query->from($db->quoteName('#__footballmanager_cheerleaders'));

...
class PlayersController extends AdminController
{
	...
	public function export()
	{
		...
		ExportHelper::export($data, 'players');
	}
...
//			move_uploaded_file($tmpFilePath, $destinationPath);
		...
		$app->enqueueMessage('Importing players is not supported yet', 'warning');
		$this->setRedirect(Route::_('index.php?option=com_footballmanager&view=players', false));
	}

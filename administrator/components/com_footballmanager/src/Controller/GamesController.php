...
class GamesController extends AdminController
{
	...
	public function export()
	{
		...
		ExportHelper::export($data, 'games');
	}
...
//			move_uploaded_file($tmpFilePath, $destinationPath);
		...
		$app->enqueueMessage('Importing games is not supported yet', 'warning');
		$this->setRedirect(Route::_('index.php?option=com_footballmanager&view=games', false));
	}

...
<form action="<?php echo Route::_('index.php?option=com_footballmanager&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>"
      method="post" name="adminForm" id="country-form" class="form-validate form-vertical">
    ...
    <div class="main-card">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-4">
		        <?php echo $this->getForm()->renderField('iso'); ?>
            </div>
            <div class="col-sm-12 col-md-4">
			    <?php echo $this->getForm()->renderField('iso3'); ?>
            </div>
            <div class="col-sm-12 col-md-4">
			    <?php echo $this->getForm()->renderField('numcode'); ?>
            </div>
        </div>
	    ...
	    <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'publishing', Text::_('COM_FOOTBALLMANAGER_CONST_PUBLISHING')); ?>
            <div class="row">
                <div class="col-sm-12 col-md-4">
		            ...
		            <?php echo $this->getForm()->renderField('modified_at'); ?>

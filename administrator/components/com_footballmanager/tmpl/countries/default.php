...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    downloadBtn.addEventListener("click", ()=>{
        taskField[0].value = 'countries.download';
    });
});
JS
);
...
{
    $saveOrderingUrl = 'index.php?option=com_footballmanager&task=countries.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
<form action="<?php echo Route::_('index.php?option=com_footballmanager&view=countries'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
						...
						foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="positionItems">
                                ...
                                <th scope="row" class="has-context">
                                    ...
                                    <a class="hasTooltip"
                                       href="<?php echo Route::_('index.php?option=com_footballmanager&task=country.edit&id=' . (int) $item->id); ?>"
